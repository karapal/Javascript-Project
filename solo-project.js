...
let text2 = onlyLetters("I have a 2 and 3 year old cat");
console.log(text2);
...
function isTodayMyBirthday(a1 , b1) {
    if (a1 === b1) {
        return true
        } else {
            return false
...
let actualBirthday = isTodayMyBirthday(02/12/2022 , 30/08/1995 );
console.log (actualBirthday);
